    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="container mx-auto flex-1 px-4 py-16">
        <div className="mx-auto max-w-3xl space-y-8">
          <h1 className="text-4xl font-bold">About PROJECT SEAL</h1>
          <p className="text-xl text-muted-foreground">
            PROJECT SEAL (Software Engineering Department Alumni & Student Network) is dedicated to fostering a lifelong
            connection between the department and its graduates.
          </p>
